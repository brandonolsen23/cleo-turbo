...
function stageFields(stage: string, data: any): FieldDef[] {
  ...
  switch (stage) {
    ...
    case "parcel_links": return [
      { ...s("resolved_arn"), section: "Parcel (determination)" },
      s("method"),
      s("parcel_file"),
      s("reason"),
      s("confidence"),
      ...
      s("containment"),
      s("loc_name"),
      s("geocode_addr_type", "addr_type"),
      s("geocode_score"),
      s("field_match"),
      s("parcel_tier", "tier"),
      { ...s("geocode.lat", "geo lat"), section: "Geocoded (determination)" },
      s("geocode.lng", "geo lng"),
      s("geocode.score", "geo score"),
      s("geocode.match_addr", "geo match_addr"),
    ];
    case "clean": return [
...
const COMPILED_CONNECTIONS: Connection[] = [
  ...
  { from: "parcel_links:method", to: "compiled:transaction.parcel_method", type: "pass" },
  ...
  { from: "parcel_links:parcel_tier", to: "compiled:transaction.parcel_tier", type: "pass" },
  { from: "parcel_links:confidence", to: "compiled:transaction.parcel_confidence", type: "pass" },
  { from: "parcel_links:containment", to: "compiled:transaction.parcel_containment", type: "pass" },
  { from: "parcel_links:loc_name", to: "compiled:transaction.parcel_loc_name", type: "pass" },
  { from: "parcel_links:geocode_addr_type", to: "compiled:transaction.parcel_addr_type", type: "pass" },
  { from: "parcel_links:geocode_score", to: "compiled:transaction.parcel_geocode_score", type: "pass" },
  { from: "parcel_links:field_match", to: "compiled:transaction.parcel_field_match", type: "pass" },
  { from: "parcel_links:pip_verified", to: "compiled:transaction.pip_verified", type: "pass" },
  { from: "parcel_links:reason", to: "compiled:transaction.parcel_reason", type: "pass" },
  ...
  { from: "parcel_links:geocode.lat", to: "compiled:property.lat", type: "pass" },
  { from: "parcel_links:geocode.lng", to: "compiled:property.lng", type: "pass" },
...
const ENGINES: EngineDef[] = [
  ...
  { id: "resolver", label: "Parcel resolver", module: "cleo/resolver", gapAfter: "clean",
    inputs: [
  ...
  { id: "brand-s", label: "normalize_brand · seller", module: "compiler/reconciler", gapAfter: "parcel_links",
    inputs: [ { field: "clean:seller.parties", type: "enrich" } ],
    outputs: [ { field: "compiled:seller.group_id", type: "enrich" } ] },
  { id: "brand-b", label: "normalize_brand · buyer", module: "compiler/reconciler", gapAfter: "parcel_links",
    inputs: [ { field: "clean:buyer.parties", type: "enrich" } ],
    outputs: [ { field: "compiled:buyer.group_id", type: "enrich" } ] },
  { id: "fp-s", label: "fingerprint · seller", module: "compiler/reconciler", gapAfter: "parcel_links",
    inputs: [ { field: "clean:seller.contacts", type: "enrich" } ],
    outputs: [ { field: "compiled:seller.contact_id", type: "enrich" } ] },
  { id: "fp-b", label: "fingerprint · buyer", module: "compiler/reconciler", gapAfter: "parcel_links",
    inputs: [ { field: "clean:buyer.contacts", type: "enrich" } ],
    outputs: [ { field: "compiled:buyer.contact_id", type: "enrich" } ] },
  { id: "phone-s", label: "normalize_phone · seller", module: "cleo/channels", gapAfter: "parcel_links",
    inputs: [ { field: "clean:seller.phone", type: "pass" } ],
    outputs: [ { field: "compiled:seller.phone", type: "pass" } ] },
  { id: "phone-b", label: "normalize_phone · buyer", module: "cleo/channels", gapAfter: "parcel_links",
    inputs: [ { field: "clean:buyer.phone", type: "pass" } ],
    outputs: [ { field: "compiled:buyer.phone", type: "pass" } ] },
  { id: "reconcile", label: "Property reconciler", module: "compiler · id_mappings", gapAfter: "parcel_links",
    inputs: [ { field: "parcel_links:resolved_arn", type: "enrich" } ],
    outputs: [
      { field: "compiled:property.id", type: "enrich" },
      { field: "compiled:transaction.property_id", type: "enrich" },
    ] },
  { id: "sqft", label: "acres → sqft", module: "compiler", gapAfter: "parcel_links",
    inputs: [ { field: "clean:site.acreage", type: "parse" } ],
    outputs: [ { field: "compiled:property.land_size_sqft", type: "parse" } ] },
  { id: "rollup", label: "Parcel roll-up · all sales on ARN", module: "compiler · post-pass", gapAfter: "parcel_links",
  ...
  { id: "owner", label: "Owner resolver · owner_overrides", module: "compiler", gapAfter: "parcel_links",
    inputs: [ { field: "clean:buyer.parties", type: "enrich" } ],
    outputs: [
      { field: "compiled:property.current_owner_name", type: "enrich" },
      { field: "compiled:property.current_owner_group_id", type: "enrich" },
    ] },
  { id: "geo", label: "Parcel file lookup · geometry", module: "cleo/resolver", gapAfter: "parcel_links",
    inputs: [ { field: "parcel_links:parcel_file", type: "enrich" } ],
    outputs: [ { field: "compiled:property.parcel_geojson", type: "enrich" } ] },
  { id: "gwlk", label: "GeoWarehouse lookup", module: "engines/gw", gapAfter: "parcel_links",
    inputs: [ { field: "clean:site.arn.api_format", type: "enrich" } ],
    outputs: [ { field: "compiled:property.gw_municipality", type: "enrich" } ] },
  { id: "classify", label: "Asset classifier", module: "classifier", gapAfter: "parcel_links",
  ...
  { id: "meta", label: "Compile metadata", module: "system", gapAfter: "parcel_links",
    inputs: [],
    outputs: [
...
const STAGE_ORDER = [
  ...
  { key: "clean", label: "Clean Record · RT-only" },
  { key: "parcel_links", label: "Determination · Parcel Links" },
