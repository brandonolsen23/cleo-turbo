...
const CONNECTIONS: Connection[] = [
  ...
  { from: "classified:header.address_entries",  to: "addresses:property.addresses[1].display",       type: "enrich" },
  { from: "classified:header.address_entries",  to: "addresses:property.addresses[1].components",    type: "enrich" },
  { from: "classified:header.address_entries",  to: "addresses:property.addresses[1].geocode_string", type: "enrich" },
  { from: "classified:header.address_entries",  to: "addresses:property.addresses[1].geocodable",    type: "enrich" },
  ...
  { from: "addresses:property.addresses[1].display",       to: "clean:property.addresses[1].display",        type: "pass" },
  { from: "addresses:property.addresses[1].components",    to: "clean:property.addresses[1].components",     type: "pass" },
  { from: "addresses:property.addresses[1].geocode_string", to: "clean:property.addresses[1].geocode_string", type: "pass" },
  { from: "addresses:property.addresses[1].geocodable",    to: "clean:property.addresses[1].geocodable",     type: "pass" },
...
function stageFields(stage: string): FieldDef[] {
  ...
  switch (stage) {
    ...
    case "addresses": return [
      { ...s("property.addresses[0].display", "addr 1 display"), section: "Property Address" },
      s("property.addresses[0].components", "addr 1 components"),
      s("property.addresses[0].geocode_string", "addr 1 geocode"),
      s("property.addresses[0].geocodable", "addr 1 geocodable"),
      s("property.addresses[1].display", "addr 2 display"),
      s("property.addresses[1].components", "addr 2 components"),
      s("property.addresses[1].geocode_string", "addr 2 geocode"),
      s("property.addresses[1].geocodable", "addr 2 geocodable"),
    ...
    case "clean": return [
      ...
      { ...s("property.addresses[0].display", "addr 1 display"), section: "Property" },
      s("property.addresses[0].components", "addr 1 components"),
      s("property.addresses[0].geocode_string", "addr 1 geocode"),
      s("property.addresses[0].geocodable", "addr 1 geocodable"),
      s("property.addresses[1].display", "addr 2 display"),
